...
module.exports = {
  ...
  organizationName: "weixiaorensheng",
  // Usually your GitHub org/user name.
  projectName: "southerly.cn",
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: "Copyright \xA9 ".concat(new Date().getFullYear(), " \u5357\u98CE  Built with Docusaurus.<p><a href=\"http://beian.miit.gov.cn/\">\u5180ICP\u590714007097\u53F7-3</a></p>")
    },
    prism: {
  ...
  plugins: [path.resolve(__dirname, "./src/plugin/plugin-baidu-analytics"), path.resolve(__dirname, "./src/plugin/plugin-baidu-push") // "@docusaurus/plugin-ideal-image",
